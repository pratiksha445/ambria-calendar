...
export const VENUES = [
  ...
  { id: 'ae',     name: 'Ambria Exotica',        short: 'AE',    color: '#B08560', textColor: '#fff', subVenues: ['Aura Lawn', 'Aura Glass House + Lawn', 'Aura Glasshouse', 'Aura Porch', 'Valencia Glass House', 'Valencia Glass House + Lawn', 'Valencia Glass House + Lawn + Poolside', 'Valencia Lawn + Poolside', 'Valencia Porch', 'Full Venue'] },
  { id: 'ar',     name: 'Ambria Restro',         short: 'AR',    color: '#6088B5', textColor: '#fff', subVenues: ['Restro-Lawn', 'Restro Glass House', 'Rooftop', 'Cafe', 'Restro Lawn + Glass House', 'Restro Lawn + Rooftop', 'Full Venue'] },
  ...
  { id: 'ws',     name: 'Wedding Services',      short: 'WS',    color: '#E85D9E', textColor: '#fff', subVenues: [] },
