...
const hi = {
  ...
  'Audit Log': 'ऑडिट लॉग',
  'Venue Managers': 'वेन्यू मैनेजर',
  'All Categories': 'सभी श्रेणियाँ',
  'ADD — Decor': 'ADD — डेकोर',
  'AC — Cuisine': 'AC — क्यूज़ीन',
  'Search manager, venue, guest…': 'मैनेजर, वेन्यू, गेस्ट खोजें…',
  'Group by Manager': 'मैनेजर के अनुसार',
  'Show all bookings': 'सभी बुकिंग दिखाएं',
  'No venue managers found': 'कोई वेन्यू मैनेजर नहीं मिला',
  ...
  'New check-out date': 'नई चेक-आउट तारीख',
  'New start date': 'नई शुरू तारीख',
  'New end date': 'नई अंतिम तारीख',
  'New date': 'नई तारीख',
  'Confirm Postpone': 'स्थगित करें',
  'Cancel Booking': 'बुकिंग रद्द करें',
  'This booking spans {start} to {end}. Cancel from which date?': 'यह बुकिंग {start} से {end} तक है। किस तारीख से रद्द करें?',
  'Cancel entire booking': 'पूरी बुकिंग रद्द करें',
  'Cancel from a specific date': 'किसी तारीख से रद्द करें',
  'Cancel from date': 'रद्द करने की तारीख',
  ...
  'Decor POC Availability': 'डेकोर POC उपलब्धता',
  'Client Feedback': 'क्लाइंट फीडबैक',
  'Presentation & Hygiene': 'प्रेजेंटेशन और स्वच्छता',
  'Completed': 'पूर्ण',
  'Unknown': 'अज्ञात',
  'Furniture': 'फर्नीचर',
